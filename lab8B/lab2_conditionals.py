...
carlae_builtins = {
    ...
    '#f': False,
    '#t': True,
    'and': lambda args: valid_relation('==', ['#t'] + args),
    'or': lambda args: not(valid_relation('==', ['#f'] + args)),
...
#                print('cond', cond)
            ...
            try: return f(args)
                ...
                raise EvaluationError('args:', args, 'wrong number of args for function', f)
...
if __name__ == '__main__':    
    ...
    test = True
    if test:
        tests = [['if', ['and', ['>', 3, 4], ['<', 5, ['define', 'x', 6]]], 1, 0], 'x']
